...
from tyger.helper.parser import mention_html, mention_markdown
from tyger.modules.help import *
from tyger import cmds

@Client.on_message(filters.me & filters.command(["admins", "adminlist"], cmds))
...
@Client.on_message(
    filters.me & filters.command(["reportadmin", "reportadmins", "report"], cmds)
)
...
@Client.on_message(filters.me & filters.command(["everyone", "mentionall"], cmds))
...
@Client.on_message(filters.me & filters.command(["botlist", "bots"], cmds))
