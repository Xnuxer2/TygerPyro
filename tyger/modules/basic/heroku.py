...
from tyger import SUDO_USER, Client
...
@Client.on_message(filters.command("logs", cmds) & filters.me & filters.user(SUDO_USER))
...
@Client.on_message(filters.command("getvar", cmds) & filters.me & filters.user(SUDO_USER))
