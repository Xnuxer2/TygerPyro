...
@Client.on_message(filters.command(["voice", "tts"], cmds) & filters.me)
...
@Client.on_message(filters.command("voicelang", cmds) & filters.me)
...
@Client.on_message(filters.command("stt", cmds) & filters.me)
